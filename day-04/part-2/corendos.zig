...
pub const Range = struct {
    ...
    pub inline fn overlaps(self: Range, other: Range) bool {
        return (other.end >= self.start and other.end <= self.end) or (other.start >= self.start and other.start <= self.end);
    }
};
