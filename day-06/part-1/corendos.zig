...
test {
    ...
    try std.testing.expectEqual(@as(i64, 7), run(input1));
    try std.testing.expectEqual(@as(i64, 5), run(input2));
    try std.testing.expectEqual(@as(i64, 6), run(input3));
    try std.testing.expectEqual(@as(i64, 10), run(input4));
    try std.testing.expectEqual(@as(i64, 11), run(input5));
}
