...
fn run(input: &str) -> u32 {
    ...
    (|| -> Option<()> {
        loop {
            ...
            unsafe {
                let r1 = RuckSack::from_items(l1.as_bytes());
                let r2 = RuckSack::from_items(l2.as_bytes());
                let r3 = RuckSack::from_items(l3.as_bytes());
                priority += r1.intersection(r2).intersection(r3).points();
            }
        }
    })();
    priority
